...
2. **`tmux-windowbar apply`** (`run-shell -b`) — registers mouse click/double-click bindings via `tmux-windowbar`/`tmux-sessionbar` commands on `PATH`, sets up window/pane event hooks
